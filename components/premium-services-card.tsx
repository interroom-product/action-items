  ...
  return (
    <Card className="border border-[#E5DDFF] shadow-lg bg-white/80 backdrop-blur-sm overflow-hidden h-full flex flex-col justify-center">
      <CardContent className="p-6 text-center flex flex-col items-center justify-center">
        {/* Visual Element inspired by the screenshot's illustration */}
        ...
        {/* Title */}
        <h3 className="text-2xl font-bold text-slate-800 mb-2">Upgrade account!</h3>

        {/* Description */}
        <p className="text-slate-500 mb-8 max-w-xs">
          Unlock our all-in-one suite of tools to accelerate your job search.
        </p>
